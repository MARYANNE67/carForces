                ...
                <div className='flex min-h-full items-center justify-center p-4 text-center'>
                  ...
                  >
                    ...
                    <div className='flex-1 flex flex-col gap-3'>
                        <div className='relative w-full h-40 bg-main-bg bg-repeat bg-cover bg-center rounded-lg'>
                          <Image src="/rightView.png" alt="car model" fill priority
                            className="object-contain"/>
                          {/* <Image src={generateCarImageUrl(car)} alt='car model' fill priority className='object-contain' /> */}
                        </div>
                      
                   {   /* DIFFERENT SIDE OF CAR */ }
                      <div className='flex gap-3'>
                        <div className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
                          <Image src="/leftView.jpeg" alt="car model" fill priority
                          className="object-contain"/>
                          {/* <Image src={generateCarImageUrl(car, "29")} alt='car model' fill priority className='object-contain' /> */}
                        </div>
                        <div className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
                          <Image src="/backView.jpeg" alt="car model" fill priority
                            className="object-contain"/>
                          {/* <Image src={generateCarImageUrl(car, "33")} alt='car model' fill priority className='object-contain' /> */}
                        </div>
                        <div className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
                          <Image src="/rightView.jpeg" alt="car model" fill priority
                            className="object-contain"/>
